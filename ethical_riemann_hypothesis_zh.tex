...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{圖表生成}：所有論文圖表由 \texttt{simulation/generate\_all\_figures.py} 腳本自動生成，執行該腳本可完全重現所有圖表。圖表以 PDF 格式保存在 \texttt{simulation/output/figures/} 目錄，並複製至 \texttt{figures/} 目錄供 \LaTeX 使用。
