...
為了說明 ERH 不僅適用於合成模擬，我們在 UCI Adult Income 資料集上進行了一個小型實證案例研究。\footnote{為了可重現性與匿名審查，我們使用本地預先處理的 Adult CSV 檔，對應程式位於 \texttt{simulation/real\_data/adult\_income\_case\_study.py}。}
