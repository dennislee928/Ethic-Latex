...
\begin{itemize}
    ...
    \item \textbf{Implementation}: Our framework supports \texttt{GroundTruthProxy.from\_mock\_rlhf()} for simulation and \texttt{load\_from\_csv()} for empirical datasets.
\end{itemize}
