...
\begin{figure}[h!]
    ...
    \caption{Structural similarity: $\alpha$ comparison across Radical, Conservative (synthetic), COMPAS, and Adult Income (real-world). COMPAS $\approx -0.32$ highlighted.}
...
\begin{figure}[h!]
    ...
    \caption{Empirical validation: Theoretical bound ($C \cdot x^{1/2}$), Radical simulation, COMPAS, and GitHub PR. Real-world curves fall within ERH bounds.}
