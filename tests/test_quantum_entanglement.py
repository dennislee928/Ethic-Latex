...
@pytest.mark.skipif(not _QISKIT_AVAILABLE, reason="qiskit and qiskit-aer required")
class TestQuantumEntanglement:
    ...
    def test_local_quantum_judge_basic(self):
        """LocalQuantumJudge produces judgment in [-1, 1]."""
        judge = LocalQuantumJudge(shots=256, seed=42)
    ...
    def test_prisoners_dilemma_correlation(self):
        ...
        Bell state |Φ⁺⟩ = (|00⟩+|11⟩)/√2: measuring both yields same bit.
        Statistical correlation between J_a and J_b across trials should be high.
        """
