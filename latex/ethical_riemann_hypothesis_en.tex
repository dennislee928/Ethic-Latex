...
\midrule
Consensus State & [QUANTUM_CONSENSUS_STATE] \\
System Coherence & [QUANTUM_SYSTEM_COHERENCE] \\
Von Neumann Entropy & [QUANTUM_VON_NEUMANN_ENTROPY] \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{lcccccp{3cm}p{5cm}}
\toprule
...
\midrule
Baseline  & 0.842 & 0.045 & $-0.12$ & Slightly higher accuracy; weaker fairness proxy and weaker structural stability \\
Mitigated & 0.838 & 0.032 & $-0.18$ & Lower group gap and more stable tail behavior; not a standalone fairness guarantee \\
\bottomrule
\end{tabular}
\end{table}
