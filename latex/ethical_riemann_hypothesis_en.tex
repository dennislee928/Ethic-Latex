...
\begin{table}[htbp]
\centering
\caption{Aggregate results for 20 simulation scenarios. Metrics are averaged across cases in each category. [TBD] indicates values to be populated by the simulation pipeline.}
