...
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{1.5cm} >{\centering\arraybackslash}p{1.7cm} >{\centering\arraybackslash}p{1.8cm} c >{\centering\arraybackslash}p{1.5cm} >{\raggedright\arraybackslash}X}
\toprule
