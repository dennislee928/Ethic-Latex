...
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{2.5cm} c c c c >{\raggedright\arraybackslash}X}
\toprule
\textbf{判斷者類型} & \textbf{錯誤率} & \textbf{平均 $|\Delta(a)|$} & \textbf{$\alpha$} & \textbf{ERH 界限?} & \textbf{整體評估} \\
\midrule
