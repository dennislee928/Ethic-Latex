...
\begin{itemize}
    ...
    \item \textbf{ERH as a necessary but not sufficient condition}: The ERH-style structural bound is, at best, a necessary condition for a morally acceptable system, not a sufficient one. As the Conservative Judge illustrates, a system can have error growth well below the ERH-style worst-case bound while still exhibiting an unacceptably high overall mistake rate.
